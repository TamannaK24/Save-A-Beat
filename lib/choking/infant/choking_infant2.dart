...
import 'choking_infant3.dart';

class ChokingInfant2 extends StatelessWidget {
  const ChokingInfant2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Text(
            'Step 2: Place 2 fingers on the middle of the breastbone just below the nipples.',
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ChokingInfant3()),
              );
            },

...
import 'cpr_step3.dart';

class CPRStep2 extends StatelessWidget {
  const CPRStep2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Text(
            'Step 2: Position the victim. Place the victim on their back with legs and arms extended',
          ...
          Center(
            child: Image.asset(
              'assets/CPR_2.png', // Replace with the image for Step 3
              height: 200,
            ),
          ),
          const SizedBox(height: 20),
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => CPRStep3()),
              );
            },
